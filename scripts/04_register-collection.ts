...
async function main() {
  ...
  const txt = await nusicStreamCoupon.connect(addr1).registerCollection(network.nftMock,1,"https://bafkreigj4ynovugfqsewvfgche6ql5gozlox7p5cjfiw7uelfscfbk3keu.ipfs.nftstorage.link/",signature);
